...
plot.state <- function(df, var_name = "Value",statistic = "mean"){
  ...
  #Putiing in an if else operator to return a message if the supplied variable is not in the df columns
...
a) Once specifying the state to be “NC”, the group being the top, the number looked at being 20
...
a) Once specifying the state to be “CA”, the group being the top, the number looked at being 15
